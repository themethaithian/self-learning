...
- AI & LLM Systems track (7th, additive, [รายละเอียด](tickets/ai-systems.md)): [x] T-ai-track (enable + tree 11 บท/53 concept + loader test) · lessons 39/53 (ch.1–8: +Guardrails & Safety) — เจาะตำแหน่ง Backend/AI-CRM ([🎯 roadmap](https://claude.ai/code/artifact/a6d332fd-de7b-44bb-91db-37549984c7a7))
