...
- Guided learning path (additive, [รายละเอียด](tickets/ux-today.md)): [x] UX-1 (has_lesson/est_minutes) [x] UX-1b (focus track pref API) [x] UX-2 (Learn page + focus picker, merged PR #42) [~] UX-3 [ ] UX-4 [ ] UX-5 [ ] UX-6 [ ] UX-7
